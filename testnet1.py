...
class AdvancedFuturesBot:
    ...
    # =========================================================================
    # معالجات الأوامر (نفس المحتوى السابق - محذوف للإيجاز)
    # =========================================================================
...
/ping - فحص الحالة
    ...
    async def start_tracking(self):
        ...
        if not self.is_running:
            ...
            self.update_task = asyncio.create_task(self.update_active_trades())
            logger.info("🔄 بدء تتبع الصفقات النشطة")
    ...
    async def stop_tracking(self):
        ...
        if self.is_running:
            ...
            logger.info("🛑 إيقاف تتبع الصفقات النشطة")
    
    def run(self):
        """تشغيل البوت"""
        logger.info("🚀 بدء تشغيل بوت العقود الآجلة المتقدم مع تتبع الصفقات...")
        
        # استخدام asyncio.run() للتشغيل الآمن
        async def main():
