...
CONFIDENCE_THRESHOLD = 41  # الحد الأدنى للنقاط لإرسال الإشعار (إشارات متوسطة وفوق)
...
ALERT_LEVELS = {
    ...
    "MEDIUM": {"min": 41, "max": 65, "emoji": "🟡", "send_alert": True, "color": "gold"},
    "HIGH": {"min": 66, "max": 80, "emoji": "🟠", "send_alert": True, "color": "darkorange"},
    "STRONG": {"min": 81, "max": 95, "emoji": "🔴", "send_alert": True, "color": "red"},
    "EXTREME": {"min": 96, "max": 100, "emoji": "💥", "send_alert": True, "color": "darkred"}
}
...
# باقي الكود بدون تغيير (TelegramNotifier, BinanceDataFetcher, والمهام)...
# [يتبع باقي الكود الموجود سابقاً بدون تغيير في الوظائف الأساسية]

class TelegramNotifier:
    """إشعارات التليجرام مع صور الشارت - بدون تغيير"""
