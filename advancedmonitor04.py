...
class CompleteTradeManager:
    ...
    def manage_new_trade(self, trade_data):
        """بدء إدارة صفقة جديدة مع وقف الخسارة المطور"""
        ...
        try:
            ...
            # ⭐ التحديث: وقف الخسارة مع مرحلتين
            ...
            # حساب الكميات لكل مستوى وقف خسارة
            ...
            self.managed_trades[symbol] = {
                **trade_data,
                'stop_loss_levels': stop_loss_levels,  # ⭐ تم التغيير من dynamic_stop_loss
                'take_profit_levels': take_profit_levels,
                'closed_stop_levels': [],  # ⭐ مستويات وقف الخسارة المغلقة
                'closed_tp_levels': [],    # مستويات جني الأرباح المغلقة
                'last_update': datetime.now(damascus_tz),
                'status': 'managed',
                'management_start': datetime.now(damascus_tz),
                'trade_expiry': trade_expiry,  # ⭐ وقت انتهاء الصفقة
                'trade_discovered_at': datetime.now(damascus_tz)  # ⭐ وقت اكتشاف الصفقة
            }
